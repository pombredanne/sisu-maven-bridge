...
public abstract class LocalMavenArtifactResolverSupport extends MavenArtifactResolverSupport {
  ...
  @Override
  protected Artifact doResolve(final ArtifactRequest artifactRequest, final RepositorySystemSession session /* ignored */, final RemoteRepository... repositories /* ignored */)
