 ...
 */
package io.tesla.maven.bridge.support.dependency.internal;
...
import io.tesla.maven.bridge.support.CollectRequestBuilder;
...
public abstract class MavenDependencyTreeResolverSupport extends ComponentSupport implements MavenDependencyTreeResolver {
  ...
  protected MavenDependencyTreeResolverSupport(final ServiceLocator serviceLocator, final @Nullable MavenModelResolver mavenModelResolver) {
  ...
  @Override
  public DependencyNode resolveDependencyTree(final CollectRequest request, final RemoteRepository... repositories) throws DependencyCollectionException {
    return resolveDependencyTree(request, assertNotNull(sessionProvider, "Repository system session provider not specified").get());
  }
  ...
  private void injectCollectionRequest(final CollectRequest request, final RepositorySystemSession session, final Model model) {
  ...
  private Model resolveModel(final CollectRequest request, final RepositorySystemSession session, final ModelBuildingRequest modelBuildingRequest) throws DependencyCollectionException {
    final Model model;
    try {
      model = assertNotNull(mavenModelResolver, "Maven model resolver is not set").resolveModel(modelBuildingRequest, session);
