...
import static io.tesla.maven.bridge.Names.DEFAULT_GLOBAL_SETTINGS_FILE;
import static io.tesla.maven.bridge.Names.DEFAULT_USER_SETTINGS_FILE;
import static io.tesla.maven.bridge.Names.GLOBAL_SETTINGS;
import static io.tesla.maven.bridge.Names.REPOSITORIES;
import static io.tesla.maven.bridge.Names.USER_SETTINGS;
...
public class DefaultMavenSettingsFactory implements MavenSettingsFactory {
  ...
  @Inject
  public DefaultMavenSettingsFactory(final ServiceLocator serviceLocator, final @Nullable @Named("${" + GLOBAL_SETTINGS + "}") File globalSettings,
      final @Nullable @Named("${" + USER_SETTINGS + "}") File userSettings, final @Nullable @Named("${" + REPOSITORIES + "}") String repositories) {
