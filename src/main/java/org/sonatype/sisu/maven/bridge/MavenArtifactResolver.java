...
public interface MavenArtifactResolver {
   ...
   * @since 2.0
   */
  Artifact resolveArtifact(ArtifactRequest request, RemoteRepository... repositories) throws ArtifactResolutionException;
   ...
   * @since 2.0
   */
  Artifact resolveArtifact(ArtifactRequest request, RepositorySystemSession session, RemoteRepository... repositories) throws ArtifactResolutionException;
