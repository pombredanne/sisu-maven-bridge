...
public interface MavenDependencyTreeResolver {
   ...
   */
  DependencyNode resolveDependencyTree(CollectRequest request, RemoteRepository... repositories) throws DependencyCollectionException;
   ...
   * @throws DependencyCollectionException If dependencies could nto be resolved
   */
  DependencyNode resolveDependencyTree(CollectRequest request, RepositorySystemSession session, RemoteRepository... repositories) throws DependencyCollectionException;
